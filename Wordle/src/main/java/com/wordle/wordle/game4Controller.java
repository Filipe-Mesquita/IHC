...
public class game4Controller implements Initializable {
    ...
    @FXML
    private Label l11, l12, l13, l14, l15, l16, l21, l22, l23, l24, l25, l26, l31, l32, l33, l34, l35, l36, l41, l42, l43, l44, l45, l46, l51, l52, l53, l54, l55, l56;
    @FXML
    ...
    private void initializeComponents() {
        ...
        if (targetWord != null && targetWord.length == 6) {
    ...
    private char[] findRandomLetterWord(String filePath) {
        ...
        if (sixLetterWords.isEmpty()) {
            return null;
        }
        Random random = new Random();
        int randomIndex = random.nextInt(sixLetterWords.size());
        String randomWord = sixLetterWords.get(randomIndex);
    ...
    private boolean isRowFullyFilled() {
        switch (currentRow) {
            case 1:
                return !l11.getText().isEmpty() && !l12.getText().isEmpty() && !l13.getText().isEmpty() && !l14.getText().isEmpty() && !l15.getText().isEmpty() && !l16.getText().isEmpty();
            case 2:
                return !l21.getText().isEmpty() && !l22.getText().isEmpty() && !l23.getText().isEmpty() && !l24.getText().isEmpty() && !l25.getText().isEmpty() && !l26.getText().isEmpty();
            case 3:
                return !l31.getText().isEmpty() && !l32.getText().isEmpty() && !l33.getText().isEmpty() && !l34.getText().isEmpty() && !l35.getText().isEmpty() && !l36.getText().isEmpty();
            case 4:
                return !l41.getText().isEmpty() && !l42.getText().isEmpty() && !l43.getText().isEmpty() && !l44.getText().isEmpty() && !l45.getText().isEmpty() && !l46.getText().isEmpty();
            case 5:
                return !l51.getText().isEmpty() && !l52.getText().isEmpty() && !l53.getText().isEmpty() && !l54.getText().isEmpty() && !l55.getText().isEmpty() && !l56.getText().isEmpty();
            default:
                return false;
        }
    }
    ...
    private boolean checkWord() {
        ...
        switch (currentRow) {
            case 1:
                inputWord.append(l11.getText()).append(l12.getText()).append(l13.getText()).append(l14.getText()).append(l15.getText()).append(l16.getText());
                score = 50;
                break;
            case 2:
                inputWord.append(l21.getText()).append(l22.getText()).append(l23.getText()).append(l24.getText()).append(l25.getText()).append(l26.getText());
                score = 40;
                break;
            case 3:
                inputWord.append(l31.getText()).append(l32.getText()).append(l33.getText()).append(l34.getText()).append(l35.getText()).append(l36.getText());
                score = 30;
                break;
            case 4:
                inputWord.append(l41.getText()).append(l42.getText()).append(l43.getText()).append(l44.getText()).append(l45.getText()).append(l46.getText());
                score = 20;
                break;
            case 5:
                inputWord.append(l51.getText()).append(l52.getText()).append(l53.getText()).append(l54.getText()).append(l55.getText()).append(l56.getText());
